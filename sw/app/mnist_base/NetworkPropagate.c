...
void propagate(const UDATA_T* inputs, Target_T* outputs, UDATA_T* maxPropagate_val)
{
    ...
    crc = 0;
    crc32(&crc, inputs, 576);
    printf("crc_inputs: 0x%08lx\n", (unsigned long) crc);
    ...
    crc = 0;
    crc32(&crc, conv1_output, 1584);
    crc32(&crc, conv1_output-576, 352);
    printf("conv1_output: 0x%08lx\n", (unsigned long) crc);
    ...
    crc = 0;
    crc32(&crc, conv2_output, 384);
    printf("conv2_output: 0x%08lx\n", (unsigned long) crc);
    ...
    crc = 0;
    crc32(&crc, fc1_output, 150);
    printf("fc1_output: 0x%08lx\n", (unsigned long) crc);
    ...
    crc = 0;
    crc32(&crc, fc2_output, 10);
    printf("fc2_output: 0x%08lx\n", (unsigned long) crc);
